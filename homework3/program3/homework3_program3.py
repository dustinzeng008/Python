...
data_dict={}                #added dictionary that maps each word to a set
                            #of indices of quotes where the word was found
for i,quote in enumerate(data_list):
    words = quote.split()
    for word in words:
        if word in data_dict:
            data_dict[word].add(i);
        else:
            data_dict[word]={i}
...
while(searchMore=="yes"):
    ...
    for i in outputSet:
        print("Found at "+str(i)+" "+data_list[i]+"\n")
